--[[
    CellD 指示器基础模块 (Indicators/Base.lua)
    所有指示器的基础类型和创建逻辑。
    提供内置指示器 (生命文本, 名字文本, 减益, 增益, 驱散, 能量条等)
    和自定义指示器 (图标, 条, 矩形, 文本, 叠加层) 的创建和管理。
--]]
local _, Cell = ...
local L = Cell.L
---@type CellFuncs
...
local circled = {"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"鈶?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銐?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?,"銑?}
