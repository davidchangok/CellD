...
L["ABOUT"] = "CellD 团队框架的灵感来主要来自 CompactRaid 与 Grid2，同时也稍微参考了 Aptechka 和 VuhDo。\nCellD 不轻量，也并非全能，其目标是提供相比以往更好的用户体验。"
L["RESET"] = "从过旧的版本更新，需要重置CellD"
L["RESET_CHARACTER"] = "从过旧的版本更新，需要重置CellD的角色配置"
L["RESET_INCLUDES"] = "这仅包括点击施法与布局自动切换"
L["RESET_YES_NO"] = "|cff22ff22是|r - 重置CellD\n|cffff2222否|r - 我自己搞定"

-------------------------------------------------
-- slash command
-------------------------------------------------
L["Available slash commands"] = "可用的斜杠命令"
L["show Cell options frame"] = "打开CellD选项界面"
L["create a \"Healers\" indicator"] = "创建一个 “Healers” 指示器"
L["reset Cell position"] = "重置CellD位置"
...
L["reset all Cell settings"] = "重置所有CellD设置"
...
L["To open options frame, use /cell options"] = "用 /celld options 来打开选项窗口"
L["Show Party"] = "小队时显示"
...
L["Use |cFFFFB5C5/cell report X|r to set the number of reports during a raid encounter"] = "用 |cFFFFB5C5/celld report X|r 来设定团队战中的通报个数"
L["Current"] = "当前"
L["all"] = "全部"
L["first %d"] = "前 %d 个"
...
L["Missing Buff"] = "缺少增益"
L["many"] = "很多"
L["Use |cFFFFB5C5/cell buff X|r to set icon size"] = "用 |cFFFFB5C5/celld buff X|r 来设定图标尺寸"
...
L["OLDER_CHANGELOGS"] = [[
    ...
    <p>* 修复团队布局预览。</p>
    <p>* 添加“应用推荐缩放”按钮和“/celld rescale”命令。</p>
    <p>* 更新怀旧服的能量过滤器。</p>
    <p>* 更新怀旧服上每列最大单位数。</p>
    <p>* 更新本地化文本。</p>
    <br/>
    ...
    <p>! 用 /celld 可以重置CellD。当CellD出现错误时，这多少能有些用。</p>
    <br/>
