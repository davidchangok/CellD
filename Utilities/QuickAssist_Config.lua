...
local function UpdatePreviewButton()
    ...
    P.Point(offensiveIcons, oit["position"][1], previewButton, oit["position"][2], oit["position"][3], oit["position"][4])
    -- size
    ...
    P.Point(buffIcons, bit["position"][1], previewButton, bit["position"][2], bit["position"][3], bit["position"][4])
    -- size
    ...
    P.Point(buffBars, bbt["position"][1], previewButton, bbt["position"][2], bbt["position"][3], bbt["position"][4])
    -- size
